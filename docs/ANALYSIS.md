...
The web interface provides real-time analysis:

- **Gesture name** — Detected primitive displayed prominently
- **Finger states** — Which fingers are extended (T/I/M/R/P)
- **Hand features** — Openness, pinch distance, span, velocity
- **ML classifier** — Additional ML-based gesture prediction
- **Recording library** — Browse and play back saved gestures

## Available Sample Recordings

The `motion_data/` directory contains 15 sample recordings:

| Gesture | Description | Frames |
|---------|-------------|--------|
| circle | Circular motion | 60 |
| fist | Closed fist | 60 |
| grab | Grabbing motion | 60 |
| ok_sign | OK gesture | 60 |
| open_hand | Open palm | 60 |
| peace | Peace sign | 60 |
| pinch | Pinching | 60 |
| point | Pointing index | 60 |
| push | Pushing forward | 60 |
| swipe_left | Left swipe | 60 |
| swipe_right | Right swipe | 60 |
| three_fingers | Three fingers | 60 |
| thumbs_up | Thumbs up | 60 |
| two_fingers | Two fingers | 60 |
| wave | Waving | 60 |

Each recording is 2 seconds at 30 FPS, containing full landmark data, finger states, features, and velocity information.
